...
def advance_system(cast) -> str:
    ...
    return (
        ...
        "每个选项另附 tag：2-6 字的行为倾向短标签（中性归类，如 当众对抗/私下化解/"
        "顺从退让/借力求助），四个标签彼此不同；标签只供旁观面板展示，不会给行动者看。\n"
        "只输出 JSON。"
    )
...
def advance_user(scene: dict, tp: dict, ledger: list[dict], state: dict,
    ...
    return (
        ...
        '  "options": [\n'
        '    {"id": "A", "text": "具体可观察的行动描述", "tag": "2-6字行为倾向标签"},\n'
        '    {"id": "B", "text": "...", "tag": "..."},\n'
        '    {"id": "C", "text": "...", "tag": "..."},\n'
        '    {"id": "D", "text": "（可选第4个）", "tag": "..."}\n'
        "  ]\n"
...
COCREATE_SYSTEM = (
    "你是SPOILER的场景共创助手。作者会向你描述一个想推演的职场场景，"
...
CRYSTALLIZE_SYSTEM = (
    "你是SPOILER的场景共创助手。下面是一段作者与你共创场景的对话记录。"
